...
feature_learners = [fast_boost, fast_prop]
...
for i in range(0, 3):
    ...
    split = getml.data.split.random(train=0.7, test=0.3, seed=i)
...
# %%
# Vermutung: da das Resultat sehr sensitiv dahingegen ist welche Features ausgewählt werden im selection step,
# sollte man einfach mehr features verwenden. Allerdings wird dann die Performance des predictors schlechter,
# das heißt man hat zu wenig Daten, und mehr Daten würden die Performance verbessern.
